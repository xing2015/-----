...
CREATE TABLE  MISSION  
 ...
 CREATE TABLE  MISSION_EQUIPE  
   ( MIS_ID  NUMBER, 
	 EQUIPE_ID  NUMBER,
	 CONSTRAINT mis_equipe_pk PRIMARY KEY(MIS_ID,EQUIPE_ID)
   ); 
...
--------------------------------------------------------
  ...
  ALTER TABLE  MISSION  ADD CONSTRAINT  VILLE_DEPART_FK  FOREIGN KEY ( MIS_VILLE_DEPART )
	  REFERENCES  VILLE  ( VILLE_ID ) ;
--------------------------------------------------------
--  Ref Constraints for Table MISSION_EQUIPE
--------------------------------------------------------

  ALTER TABLE  MISSION_EQUIPE  ADD CONSTRAINT  EQUIPE_FK  FOREIGN KEY ( EQUIPE_ID )
	  REFERENCES  EQUIPE  ( EQUIPE_ID ) ;
  ALTER TABLE  MISSION_EQUIPE  ADD CONSTRAINT  MIS_FK  FOREIGN KEY ( MIS_ID )
	  REFERENCES  MISSION  ( MIS_ID ) ;
--------------------------------------------------------
